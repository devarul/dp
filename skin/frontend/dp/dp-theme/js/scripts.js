...
/********************************************************************* swipe *****************************************************************************/
	   ...
	   jQuery('.swipe').outerHeight(jQuery(window).outerHeight());
		...
		/*if(jQuery(".blog-bg").length){  
			jQuery(".blog-bg").vide("media/video/video_1");
		};*/
...
jQuery(window).load(function(){
	...
	var isMobile = /Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent);
	if(!isMobile) {
		if(jQuery(".new_arrivals").length){  jQuery(".new_arrivals").cherryFixedParallax({  invert: false });};  
		if(jQuery(".index_block").length){  jQuery(".index_block").cherryFixedParallax({  invert: false });};
