...
class LitExtension_SocialLogin_Helper_Twitter extends Mage_Core_Helper_Abstract
{

    public function disconnect(Mage_Customer_Model_Customer $customer) {
        Mage::getSingleton('customer/session')
                ->unsLeSocialloginTwitterUserinfo();
        ...
        $pictureFilename = Mage::getBaseDir(Mage_Core_Model_Store::URL_TYPE_MEDIA)
                ...
                .'twitter'
                .DS                
                .$customer->getLeSocialloginTid();
        
        if(file_exists($pictureFilename)) {
            @unlink($pictureFilename);
        }        
        
        $customer->setLeSocialloginTid(null)
    ...
    public function connectByTwitterId(
            ...
            $token)
    {
        $customer->setLeSocialloginTid($twitterId)
    ...
    public function getCustomersByTwitterId($twitterId)
    {
        ...
        $collection = $customer->getCollection()
            ->addAttributeToFilter('le_sociallogin_tid', $twitterId)
            ->setPageSize(1);
